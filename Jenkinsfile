    ...
    stages {
        ...
        stage('Run Postman Tests') {
            steps {
                ...
                sh 'npx newman run tests/bookstore.postman_collection.json -e tests/bookstore_environment.json -r cli,html --reporter-html-export tests/reports/newman-report.html'
            }
        }
